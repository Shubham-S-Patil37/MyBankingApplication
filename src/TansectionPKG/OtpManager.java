...
public class OtpManager extends javax.swing.JFrame {
    ...
    public OtpManager() {        
        ...
        otpTxt.setText(Utilities.randomNumber());
        OTP = otpTxt.getText(); // Static String use in another class   
    }
    ...
    private void initComponents() {
        ...
        otpTxt.setFont(new java.awt.Font("Tahoma", 0, 36)); // NOI18N
        otpTxt.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        otpTxt.setText("jTextField1");
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(otpTxt, javax.swing.GroupLayout.PREFERRED_SIZE, 599, javax.swing.GroupLayout.PREFERRED_SIZE))))
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        Utilities.copyText(otpTxt.getText());
        jLabel1.setText("OTP COPIED");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OtpManager.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new OtpManager().setVisible(true);
            }
        });
    }
